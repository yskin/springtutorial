...
//			InstructorDetail instructorDetail = new InstructorDetail("https://youtube.com/darby", "Cording");

			Instructor instructor = new Instructor("Madhu", "Patel", "patel@gmail.com");
			InstructorDetail instructorDetail = new InstructorDetail("https://youtube.com/patel", "Guitar");

			// associate the objects
			instructor.setInstroctorDetail(instructorDetail);
			// start a transaction
